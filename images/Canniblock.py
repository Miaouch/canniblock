...
def update(dt):
    ...
    for brick_bis in all_bricks_bis:
        if ball.colliderect(brick_bis):
            if ball.pos[0] >= brick_bis.left and ball.pos[0] <= brick_bis.right:
                sounds.impact5.play()
    ...
    for super_brick_bis in all_super_bricks_bis:
        if super_brick_bis.colliderect(ball):
            if ball.pos[0] >= super_brick_bis.left and ball.pos[0] <= super_brick_bis.right:
                sounds.impact5.play()
    ...
    for hyper_brick in all_hyper_bricks:
        if hyper_brick.colliderect(ball):
            if ball.pos[0] >= hyper_brick.left and ball.pos[0] <= hyper_brick.right:
                sounds.impact5.play()
    ...
    for i in range(len(all_second_balls)):    
        ...
        if all_second_balls[i].colliderect(player):
            if all_second_balls[i][0] >= player.left and all_second_balls[i][0] <= player.right:
                sounds.game_bump.play()
                invert_vertical_speed_second_ball(i)
        ...
        for brick in all_bricks:
            if all_second_balls[i].colliderect(brick):
                if all_second_balls[i][0] >= brick.left and all_second_balls[i][0] <= brick.right:
                    sounds.impact5.play()
                    all_bricks.remove(brick)
                    invert_vertical_speed_second_ball(i)
                else:
        ...
        for super_brick in all_super_bricks:
            if super_brick.colliderect(all_second_balls[i]):
                if all_second_balls[i][0] >= super_brick.left and all_second_balls[i][0] <= super_brick.right:
                    sounds.impact5.play()
                    all_super_bricks.remove(super_brick)
                    invert_vertical_speed_second_ball(i)
                else:
        ...
        for brick_bis in all_bricks_bis:
            if all_second_balls[i].colliderect(brick_bis):
                if all_second_balls[i][0] >= brick_bis.left and all_second_balls[i][0] <= brick_bis.right:
                    sounds.impact5.play()
                    all_bricks_bis.remove(brick_bis)
                    invert_vertical_speed_second_ball(i)
                else:
        ...
        for super_brick_bis in all_super_bricks_bis:
            if super_brick_bis.colliderect(all_second_balls[i]):
                if all_second_balls[i][0] >= super_brick_bis.left and all_second_balls[i][0] <= super_brick_bis.right:
                    sounds.impact5.play()
                    all_super_bricks_bis.remove(super_brick_bis)
                    invert_vertical_speed_second_ball(i)
                else:
        ...
        for hyper_brick in all_hyper_bricks:
            if hyper_brick.colliderect(all_second_balls[i]):
                if all_second_balls[i][0] >= hyper_brick.left and all_second_balls[i][0] <= hyper_brick.right:
                    sounds.impact5.play()
                    all_hyper_bricks.remove(hyper_brick)
                    invert_vertical_speed_second_ball(i)
                else:
